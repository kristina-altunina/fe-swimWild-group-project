  ...
  return (
    <View style={styles.app}>
      ...
      <View style={styles.profile}>
        <View style={styles.profile__text}>
          ...
          <Text style={styles.profile__home}>{profileData.dob}</Text>
            <TextInput onChangeText={(value)=> setMyLocation(value)} editable={editMode} placeholder={editMode ? "Your location" : ""} 
            style={[styles.profile__myLocation, editMode ? {borderWidth: 2, borderColor: colours.accent4} : {borderWidth: 0}]}>
           {profileData.home}
            </TextInput> 
        </View>

        {profileImg ? (
          <TouchableHighlight onPress={imageUploadFromGallery} disabled={!editMode}>
          <Image style={[styles.profile__img, editMode ? {borderWidth: 3, borderColor: colours.accent4} : {}]}
            resizeMode={"cover"}
            source={{
              uri: profileImg,
            }}
          ...
          <Image
            style={[styles.profileImg, editMode ? {borderWidth: 3, borderColor: colours.accent4} : {}]}
      ...
      <TextInput
        ...
        style={[styles.profile__bio, editMode ? {borderWidth: 2, borderColor: colours.accent4} : {borderWidth: 2}]}
        />
      </View>
      <View style={[styles.button__container, editMode ? styles.textShow : styles.textHide]} >
